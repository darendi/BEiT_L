...
def process_images(input_folder, segmented_folder):
    ...
    processor = BeitFeatureExtractor.from_pretrained("microsoft/beit-base-finetuned-ade-640-640")
    model = BeitForSemanticSegmentation.from_pretrained("microsoft/beit-base-finetuned-ade-640-640")

    # Load the JSON color map
    with open("/home/darendy/BEiT_L_ADE20K/objectName150_colors150.json") as f:
...
output_segmented_folder = "/home/darendy/BEiT_L_ADE20K/segmented_images"
